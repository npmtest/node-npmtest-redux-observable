...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-redux-observable/node_modules/redux-observable/lib/cjs/ActionsObservable.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-redux-observable/node_modules/redux-observable/lib/cjs/ActionsObservable.js</span></h1>
    <h2>
        
        Statements: <span class="metric">56.67% <small>(34 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">39.39% <small>(13 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-redux-observable/node_modules/redux-observable/lib/cjs/</a> &#187; ActionsObservable.js</div>
</div>
<div class="body">
...
&nbsp;
  _createClass(ActionsObservable, null, [{
    key: 'of',
    value: <span class="fstat-no" title="function not covered" >function of() {</span>
<span class="cstat-no" title="statement not covered" >      return new this(_of2.of.apply(undefined, arguments));</span>
    }
  }, {
    key: 'from',
    value: <span class="fstat-no" title="function not covered" >function from(actions, scheduler) {</span>
<span class="cstat-no" title="statement not covered" >      return new this((0, _from2.from)(actions, scheduler));</span>
    }
  }]);
&nbsp;
<span class="fstat-no" title="function not covered" >  function ActionsObservable(actionsSubject) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ActionsObservable);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (ActionsObservable.__proto__ || Object.getPrototypeOf(ActionsObservable)).call(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.source = actionsSubject;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  _createClass(ActionsObservable, [{
    key: 'lift',
    value: <span class="fstat-no" title="function not covered" >function lift(operator) {</span>
<span class="cstat-no" title="statement not covered" >      var observable = new ActionsObservable(this);</span>
<span class="cstat-no" title="statement not covered" >      observable.operator = operator;</span>
<span class="cstat-no" title="statement not covered" >      return observable;</span>
    }
  }, {
    key: 'ofType',
    value: <span class="fstat-no" title="function not covered" >function ofType() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _filter.filter.call(this, <span class="fstat-no" title="function not covered" >function (_ref) {</span></span>
<span class="cstat-no" title="statement not covered" >        var type = _ref.type;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          return type === keys[0];</span>
        } else {
<span class="cstat-no" title="statement not covered" >          for (var i = 0; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >            if (keys[i] === type) {</span>
